package com.craftaro.core.nms.v1_21_R4.world;
...
public class SSpawnerImpl implements SSpawner {
    ...
    public LivingEntity spawnEntity(EntityType type, String particleType, SpawnedEntity spawned, Set<XMaterial> canSpawnOn) {
        ...
        for (int i = 0; i < 50; ++i) {
            ...
            Optional<Entity> optionalEntity = net.minecraft.world.entity.EntityType.create(compound, world, EntitySpawnReason.SPAWNER);
